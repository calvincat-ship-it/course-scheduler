...
<div class="wrap">
  <header class="head">
    <h1>全校課表 · 自動排課結果</h1>
    <p class="sub">忠孝全科同步（每年級忠孝共用一張表）· 依 12 條硬規則自動填課 · 第七節排輕科或級任課(母語豁免) · 母語鎖週四且教師週四純母語 · 彈性在地鎖週五第一節 · 體育跨日隔天 · 教師單日≤5(母語例外) · 級任上下午各≥1節·連堂≤3 · 主科上午<br>
    來源：課務編排 v02 匯出資料 · 6 年級 12 班 24 位教師 · 共 336 格</p>
    <span class="pill">獨立驗證通過：0 衝堂 · 0 違規 · 節數全符 · 主科下午 0 格</span>
